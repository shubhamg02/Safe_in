...
import 'package:flutter_twitter_clone/Shop/screens/splash_page.dart';
import 'package:flutter_twitter_clone/page/book.dart';
    ...
    return authstate.isbusy
        ...
        : list == null || list.length < 1
            ? Container(
                ...
                child: NotifyText(
                  title: isMyProfile
                      ? 'You haven\'t ${isreply ? 'reply to any query' : isMedia ? 'post any media  yet' : 'post any Blog yet'}'
                      : '${authstate.profileUserModel.userName} hasn\'t ${isreply ? 'reply to any Query' : isMedia ? 'post any media yet' : 'post any Blog yet'}',
                  subTitle: isMyProfile
                      ? 'Tap Add Blog button to add new'

...
import 'select_payment_type_page.dart';
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Column(
                ...
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  Text("Booking charges", style: TextStyle(fontSize: 16.0, color: Colors.black, fontWeight: FontWeight.w400),),
                  Row(
                    children: <Widget>[
                      Text("Charges", style: TextStyle(fontSize: 12.0, color: Colors.black54, fontWeight: FontWeight.w400),),
                      Spacer(),
                  ...
                  Row(
                    children: <Widget>[
                      Text("GSt + tax", style: TextStyle(fontSize: 12.0, color: Colors.black54, fontWeight: FontWeight.w400),),
                      Spacer(),

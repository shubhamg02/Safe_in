...
class _TrackingPageState extends State<TrackingPage> {
  ...
  String selectedProduct = 'Healthex HX100 Exercise Gym Cycle';
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton(
                          items: <String>[
                            'Healthex HX100 Exercise Gym Cycle',
                            'Healthex HX200 Exercise Gym Cycle',
                            'Healthex HX300 Exercise Gym Cycle',
                            'Healthex HX400 Exercise Gym Cycle',
                            'Healthex HX500 Exercise Gym Cycle',
                            'Healthex HX600 Exercise Gym Cycle'
                          ].map((val) {

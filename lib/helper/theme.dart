...
class AppTheme{
  static final ThemeData apptheme = ThemeData(
    ...
    accentColor: TwitterColor.black,
    ...
    appBarTheme: AppBarTheme(
      ...
      iconTheme: IconThemeData(color: TwitterColor.black,),
      elevation: 0,
      textTheme:  TextTheme(
        title: TextStyle(
          color: Colors.black,
        ...
        tabBarTheme: TabBarTheme(
          labelStyle: titleStyle.copyWith(color: TwitterColor.black),
          unselectedLabelColor: AppColor.darkGrey,
          unselectedLabelStyle: titleStyle.copyWith(color: AppColor.darkGrey),
          labelColor: TwitterColor.black,
